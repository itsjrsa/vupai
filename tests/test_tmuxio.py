...
def test_enable_pane_titles_runs_both_set_commands(monkeypatch):
    ...
    assert fake.calls[2]["args"] == [
        ...
        "#{?pane_active,"
        "#[bold]#{?@vupai_name,"
        "#[bg=colour30]#[fg=colour231] #{@vupai_name}#{?@vupai_program, · #{@vupai_program},} #[default]#[bold] · #{pane_title},"  # noqa: E501
        "#{?@vupai_program,#{@vupai_program} · ,}#{pane_title}},"
        "#{?@vupai_name,"
        "#[bg=colour238]#[fg=colour253]#[bold] #{@vupai_name}#{?@vupai_program, · #{@vupai_program},} #[default] · #{pane_title},"  # noqa: E501
        "#{?@vupai_program,#{@vupai_program} · ,}#{pane_title}}}",
    ]
